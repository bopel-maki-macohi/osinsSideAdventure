...
class OptionsSubState extends FlxSubState
{
	...
	override function update(elapsed:Float)
	{
		...
		_optionText.screenCenter();
		_optionText.y = FlxG.height - _optionText.height - 32;
	}

	public var _optionText:FlxText;

	public function setOptionText(text:String)
	...
	public function makeCreditSprite(asset:String, creditText:String, ?url:String):ClickableSprite
	{
		...
		credSpr._overlapUpdate.add(() -> setOptionText(creditText));
		if (url != null)
	...
	override function create()
	{
		...
		_optionText = new FlxText(0, 0, 0, '', 16);
		_optionText.setBorderStyle(OUTLINE, FlxColor.BLACK, 2);
		_optionText.camera = TitleState.blurCamFG;
